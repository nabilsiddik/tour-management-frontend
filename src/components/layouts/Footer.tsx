  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="container mx-auto pt-16 px-5">
        ...
        <div className="my-10 flex items-center justify-between flex-col gap-5 sm:flex-row">
            ...
            <ul className="flex justify-center gap-6 sm:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-forground transition hover:text-teal-700/75 dark:text-foreground dark:hover:text-teal-500/75"
                >
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-teal-700 transition hover:text-teal-700/75 dark:text-foreground dark:hover:text-teal-500/75"
                >
        ...
        <div className="mt-16 text-center border-t h-20 flex items-center justify-center">
          <p className="text-center text-sm text-foreground">
            Copyright &copy; 2025. All rights reserved by Tour Hobe.
          </p>
        </div>
